        ...
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center relative px-4">
          ...
          <div className="hidden lg:block  absolute md:top-[-70px] md:left-[-80px] lg:top-[-160px] xl:top-[-140px]  2xl:top-[-70px]">
            <Image
              ...
              width={187}
              height={187}
              className="lg:w-[287px] lg:h-[287px]"
            />
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center w-full gap-8 lg:gap-16">
            ...
            <div className="flex flex-col space-y-4 max-w-lg text-center lg:text-left px-4 lg:px-0">
              ...
              <h1 className="text-2xl sm:text-[34px] font-josefin font-bold text-gray-900 leading-tight">
          ...
          {/* Sliding Dots */}
          <div className="flex space-x-2 mt-6 absolute bottom-4 sm:bottom-8 lg:bottom-14 left-1/2 transform -translate-x-1/2 lg:left-auto lg:transform-none">
